...
class PopularHotelCard extends StatelessWidget {
  ...
  final MyFavoriteService favoriteService = Get.find<MyFavoriteService>();
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              right: 12,
              child: Obx(() {
                final isFavorite = favoriteService.isFavorite(hotel);

                return GestureDetector(
                  onTap: () {
                    favoriteService.toggleFavorite(hotel);
                  },
